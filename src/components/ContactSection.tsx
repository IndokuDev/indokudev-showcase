import { MessageCircle, Mail, Github, Youtube, Instagram, MapPin } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Mau kolaborasi atau sekadar ngobrol? Feel free to reach out!
          </p>
        </div>
              ...
              <Card className="bg-gradient-card border-border/50 hover:border-primary/30 transition-all duration-300 hover:shadow-glow h-full">
                <CardContent className="p-6 flex items-center gap-4">
                  <div className={`p-3 rounded-xl bg-muted group-hover:bg-primary/10 transition-colors`}>
                    <method.icon className={`w-5 h-5 text-muted-foreground ${method.color} transition-colors`} />
                  </div>
                  <div>
        ...
        <div className="text-center">
          <Card className="bg-gradient-primary p-[2px] rounded-2xl overflow-hidden">
            <CardContent className="bg-card rounded-2xl p-8 md:p-12">
              <h3 className="text-2xl font-bold mb-4">Ready to Work Together?</h3>
              <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                Punya project atau ide yang mau didiskusiin? Let's make it happen!
              </p>
              <Button 
                size="lg" 
